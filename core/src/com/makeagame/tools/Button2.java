...
public class Button2 {//implements View {
	...
	public void setDisableSprite(Sprite sprite) { spDisable = sprite; }
	public void setDisableAnimation(KeyTable keytable) { ktDisable = keytable; }
	
	public void setInactiveSprite(Sprite sprite) { spInactive = sprite; }
	public void setInactiveAnimation(KeyTable keytable) { ktInactive = keytable; }
	
	public void setStaticSprite(Sprite sprite) { spStatic = sprite; }
	public void setStaticAnimation(KeyTable keytable) { ktStatic = keytable; }
	
	public void setHoveredSprite(Sprite sprite) { spHovered = sprite; }
	public void setHoveredAnimation(KeyTable keytable) { ktHovered = keytable; }
	
	public void setPushedSprite(Sprite sprite) { spPushed = sprite; }
	public void setPushedAnimation(KeyTable keytable) { ktPushed = keytable; }
	...
	public void apply(Sprite sprite) {
		...
		*/
		...
		case Disable:
			...
			if (ktDisable != null) { sprite.apply(ktDisable.get(enable_state.elapsed())); }
			break;
		case Inactive:
			if (spInactive != null) { sprite.copyFrom(spInactive); }
			if (ktInactive != null) { sprite.apply(ktInactive.get(enable_state.elapsed())); }
			break;
		case Active:
			...
			case Static:
				...
				if (ktStatic != null) { sprite.apply(ktStatic.get(action_state.elapsed())); }
				break;
			case Hovered:
				if (spHovered != null) { sprite.copyFrom(spHovered); }
				if (ktHovered != null) { sprite.apply(ktHovered.get(action_state.elapsed())); }
				break;
			case Pushed:
				if (spPushed != null) { sprite.copyFrom(spPushed); }
				if (ktPushed != null) { sprite.apply(ktPushed.get(action_state.elapsed())); }
				break;
			}
			break;
		}
