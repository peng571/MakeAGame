...
public class ViewField extends SimpleLayout {
	...
	public ViewField() {
		...
		roleKeyTable[0] = new KeyTable(new Frame[] {
				...
				new Frame( 300, new Key[] { new Key("image", "role_walk2") }),
				new Frame( 600, new Key[] { new Key("image", "role_walk3") }),
//				new Frame( 600, new Key[] { new Key("image", "role_walk4") }),
//				new Frame( 500, new Key[] { new Key("image", "role_walk4") }),
...
//				new Frame( 0, new Key[] { new Key("image", "role_walk3") }),
				new Frame( 0, new Key[] { new Key("image", "role_attack1") }),
